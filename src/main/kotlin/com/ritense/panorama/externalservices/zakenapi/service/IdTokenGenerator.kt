 ...
 */
package com.ritense.panorama.externalservices.zakenapi.service
...
class IdTokenGenerator {
    fun generateToken(
        ...
        require(secretKey.length >= 32) {
            SECRET_KEY_LENGTH_ERROR_MESSAGE
        }
    ...
    companion object {
        ...
        private const val SECRET_KEY_LENGTH_ERROR_MESSAGE = "SecretKey needs to be at least 32 in length"
    }
}
